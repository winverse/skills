...
- Use $skill-to-html at <skills-root>/skills/skill-to-html/SKILL.md whenever a skill is created, installed, forked, or updated, so the skill folder gets a 도표 중심 `skill.html` beside `SKILL.md`.
...
- Prefer 판단 매트릭스, 흐름도, 순위 차트, 파일 관계도, and 입출력 구조.
