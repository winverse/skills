...
const requiredChecks = [
  ...
  ["SKILL.md", "domain invariant"],
  ["references/feature-workflow-playbook.md", "work claim preflight 기준"],
  ["references/feature-workflow-playbook.md", "domain structure preflight 기준"],
  ["references/feature-workflow-playbook.md", "TDD starting point"],
  ...
  ["references/upstream-dependency-map.md", "`superpowers.writing-plans`"],
  ["references/upstream-dependency-map.md", "`gstack.plan-eng-review`"],
  ["references/upstream-dependency-map.md", "`repo-plugin.project-workflow`"],
  ["agents/openai.yaml", "stop with an overlap block"],
  ["agents/openai.yaml", "domain-first folder map"],
  ["agents/openai.yaml", "domain invariant"],
  ...
  ["../../project-snippets/feature-workflow.md", "domain-first folder map"],
  ["../../project-snippets/feature-workflow.md", "domain invariant"],
