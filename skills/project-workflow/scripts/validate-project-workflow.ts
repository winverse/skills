...
const requiredChecks = [
  ...
  ["../../project-snippets/project-workflow.md", "grill-with-docs"],
  ["../../project-snippets/project-workflow.md", "grill-me` is not the default project setup gate"],
  ...
  ["../../project-snippets/base.md", "grill-with-docs"],
  ...
  ["../../project-snippets/claude-base.md", "grill-with-docs"],
  ...
  ["../../plugins/project-workflow/README.md", "프로젝트 워크플로우 테스트 방법"],
  ...
  ["../../docs/project-workflow-test-method.md", "Cycle 절차"],
  ["../../docs/project-workflow-test-method.md", "`grill-with-docs` -> `office-hours` -> Superpowers `brainstorming` setup gap check"],
  ["../../docs/project-workflow-test-method.md", "`current/`는 매 cycle 시작 전에 삭제하고 다시 만든다"],
] as const;
