...
const requiredChecks = [
  ...
  ["SKILL.md", "대상 스킬 자체를 설명해야 한다"],
  ["SKILL.md", "변환기의 입력/출력이나 레이아웃 기준을 대상 스킬 요약으로 쓰지 않는다"],
  ["SKILL.md", "operationalInputs"],
  ["SKILL.md", "operationalOutputs"],
  ["SKILL.md", "대상 스킬의 실제 작업 모델"],
  ["SKILL.md", "일반 Markdown 문서 mode"],
  ["SKILL.md", "복잡한 구조"],
  ["SKILL.md", "긴 문단"],
  ["SKILL.md", "본문 의미와 세부 구조를 보존"],
  ["SKILL.md", "복잡하다는 이유만으로 내용을 삭제하지 않는다"],
  ...
  ["references/visual-guide-standards.md", "대상 스킬의 핵심을 말해야 한다"],
  ["references/visual-guide-standards.md", "변환기의 입력이지 대상 스킬의 입력이 아니다"],
  ["references/visual-guide-standards.md", "대상 스킬이 실제로 받는"],
  ["references/visual-guide-standards.md", "대상 스킬의 실제 작업 모델"],
  ...
  ["references/visual-guide-standards.md", "복잡한 구조를 보존"],
  ["references/visual-guide-standards.md", "긴 table"],
  ["references/visual-guide-standards.md", "복잡하다는 이유만으로 본문을 버리지 않는다"],
  ...
  ["skill.html", "일반 Markdown 문서 mode"],
  ["skill.html", "복잡한 구조"],
  ["skill.html", "한국어 우선"],
  ["skill.html", "인터랙션 없음"],
  ["skill.html", "MarkdownHtmlModel"],
  ["skill.html", "대상 스킬 자체를 설명"],
  ["skill.html", "실제 입력/출력"],
  ["skill.html", "대상 중심"],
  ["skill.html", "신뢰된 템플릿"],
  ...
  ["../../project-snippets/markdown-to-html.md", "target skill's name"],
  ["../../project-snippets/markdown-to-html.md", "operational inputs"],
  ["../../project-snippets/markdown-to-html.md", "not the `markdown-to-html` conversion process"],
  ["../../project-snippets/markdown-to-html.md", "skill HTML mode"],
  ["../../project-snippets/markdown-to-html.md", "general Markdown document mode"],
  ["../../project-snippets/markdown-to-html.md", "complex source structure"],
  ["../../project-snippets/markdown-to-html.md", "preserve heading hierarchy"],
  ...
  ["../../scripts/validate-skill-html.ts", "summary should describe the target skill"],
  ["agents/openai.yaml", "safe, Korean-first"],
  ["agents/openai.yaml", "default_prompt: >-"],
  ["agents/openai.yaml", "skill HTML mode"],
  ["agents/openai.yaml", "target skill's name"],
  ["agents/openai.yaml", "operational inputs"],
  ["agents/openai.yaml", "not the markdown-to-html conversion process"],
  ["agents/openai.yaml", "general Markdown document mode"],
  ["agents/openai.yaml", "complex source structure"],
  ["agents/openai.yaml", "preserve"],
