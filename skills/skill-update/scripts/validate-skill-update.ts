...
const requiredChecks = [
  ...
  ["SKILL.md", "scripts/validate-source-registry.ts"],
  ["SKILL.md", "SVG arrow endpoint"],
  ["SKILL.md", "overflow, text overlap"],
  ["SKILL.md", "source id와 local delta 이유만"],
  ["references/update-checklist.md", "docs/update-source-registry.md"],
  ["references/update-checklist.md", "source id"],
  ["references/update-checklist.md", "usage map"],
  ...
  ["references/update-checklist.md", "scripts/validate-source-registry.ts"],
  ...
  ["references/update-checklist.md", "references, snippets, history에는 위 장부를 복사하지 않는다"],
  ...
  ["agents/openai.yaml", "single source registry"],
  ["agents/openai.yaml", ".gitmodules"],
  ["agents/openai.yaml", "scripts/validate-source-registry.ts"],
  ...
  ["../../docs/update-source-registry.md", "단일 진실원 원칙"],
  ["../../docs/update-source-registry.md", "source id"],
  ["../../docs/update-source-registry.md", "usage map"],
  ...
  ["../../project-snippets/skill-update.md", "single source registry"],
