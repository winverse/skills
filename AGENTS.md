...
- Plugin folders live under `plugins/`, for example `plugins/context-mode/`; upstream plugins should be pinned as submodules when the user wants the plugin preserved as-is.
