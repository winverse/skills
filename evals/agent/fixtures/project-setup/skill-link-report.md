# Project Setup Verification Fixture
...
- skills/sync-docs/skill.html

Result:
- No global install instruction found.
- Project-specific overrides stay in AGENTS.md.
- Snippet source compared with docs/project-skill-setup.md.
